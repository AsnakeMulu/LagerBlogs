"""
Django settings for lager_blogs project.
...
SECRET_KEY = 'django-insecure-+lp0z7@hjd-su%m97ytysh@xm#_3t&wv18^_5ct_z!447j%bj4'
...
WSGI_APPLICATION = 'lager_blogs.wsgi.application'
